    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('airplane_id')->label("Airplane"),
                Tables\Columns\TextColumn::make('start_airport_id')->label("Start Airport"),
                Tables\Columns\TextColumn::make('end_airport_id')->label("End Airport"),
            ])
            ->filters([
                //
            ])
